...
boolean allowClick = true; // Control clicks during match check
int buttonHeight = 40; // Height of buttons
String difficulty = "4x5"; // Default difficulty

// Button positions and sizes
int btn2x5X = 10, btn2x5Y = 10;
int btn4x5X = 110, btn4x5Y = 10;
int btn8x5X = 210, btn8x5Y = 10;
int btn12x5X = 310, btn12x5Y = 10;
int btnWidth = 80;
